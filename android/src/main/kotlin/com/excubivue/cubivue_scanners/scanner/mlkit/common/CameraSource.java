...
package com.excubivue.cubivue_scanners.scanner.mlkit.common;
...
public class CameraSource {
    ...
    private String mFlashMode = Camera.Parameters.FLASH_MODE_TORCH;
    ...
    public static SizePair getCameraPreviewSizePair(Context context, int cameraId) {
        ...
        try {
            return new SizePair(
                    Size.parseSize(DEFAULT_REQUESTED_CAMERA_PREVIEW_WIDTH + ""),
                    Size.parseSize(DEFAULT_REQUESTED_CAMERA_PREVIEW_HEIGHT + ""));
        } catch (Exception e) {
            return null;
        }
    }
    ...
    private Camera createCamera() throws IOException {
        ...
        Log.i(TAG, "Zoom Level: " + maxZoomLevel);
        ...
        if (requestedAutoFocus) {
            if (parameters.getSupportedFocusModes().contains(Camera.Parameters.FOCUS_MODE_CONTINUOUS_VIDEO) ||
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    Log.i(TAG, "Camera focus set for Android 8+ devices.");
                    parameters.setFocusMode(Camera.Parameters.FOCUS_MODE_CONTINUOUS_VIDEO);
                } else {
                    Log.i(TAG, "Camera focus set for Android 7+ devices.");
