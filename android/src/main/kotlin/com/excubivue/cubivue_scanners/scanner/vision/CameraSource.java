...
public class CameraSource {
    ...
    private Context cameraActivity = null;
    /**
    ...
    private static List<SizePair> generateValidPreviewSizeList(Camera camera) {
        ...
        try {
            ...
            if (validPreviewSizes.size() == 0) {
                Log.i(TAG, "generateValidPreviewSizeList: No preview sizes have a corresponding same-aspect-ratio picture size");
            ...
            e.printStackTrace();
            Log.i(TAG, "generateValidPreviewSizeList: No preview sizes have a corresponding same-aspect-ratio picture size: " + Utils.getInstance().getStackTrace(e));
            validPreviewSizes.add(new SizePair(new Size(1280, 720)));
        }
        ...
        synchronized (mCameraLock) {
            ...
            if (mCamera != null) {
                try {
                    ...
                    e.printStackTrace();
                    Log.i(TAG, "start: "+Utils.getInstance().getStackTrace(e));
                }
            }
        }
        return this;
        ...
        synchronized (mCameraLock) {
            ...
            if (mProcessingThread != null) {
                try {
                    ...
                    Log.i(TAG, "stop: Frame processing thread interrupted on release.");
            ...
            if (mCamera != null) {
                ...
                try {
                    ...
                    Log.i(TAG, "stop: Failed to clear camera preview: " + Utils.getInstance().getStackTrace(e));
        ...
        synchronized (mCameraLock) {
            if (mCamera != null && mode != null) {
                ...
                if (supportedFlashModes != null && supportedFlashModes.contains(mode)) {
                    ...
                    Log.i(TAG, "setFlashMode: No supported Flash Mode!");
                }
            } else {
                Log.i(TAG, "setFlashMode: Null Camera Supplied");
            }
            return false;
        }
    }
    ...
    private Camera createCamera() {
        ...
        //Force use back camera
        int requestedCameraId = CAMERA_FACING_BACK;
        Camera camera = Camera.open(requestedCameraId);


        //If camera is null, restart the activity
        if (camera == null) {
            try {
                if (mCamera != null) {
                    mCamera.release();
                } else {
                    Log.i(TAG, "createCamera: Null Camera Supplied");
                }
            } catch (Exception e) {
                Log.i(TAG, "createCamera: Null Camera Supplied: " + Utils.getInstance().getStackTrace(e));
            } finally {
                //Restart
                ((MaterialBarcodeScannerActivity) cameraActivity).restartActivity();
            }
            return null;
        }

        //If camera.getParameters() is null or throwing any exception,restart the activity
        try {
        ...
        try {
            ...
            if (sizePair == null) {
                Log.i(TAG, "createCamera: Could not find suitable preview size.");
            ...
            if (previewFpsRange == null) {
                Log.i(TAG, "createCamera: Could not find suitable preview frames per second range.");
            ...
            if (pictureSize != null) {
                ...
                Log.i(TAG, "createCamera: No picture size");
            }
            ...
            if (mFocusMode != null) {
                if (parameters.getSupportedFocusModes().contains(
                    ...
                    Log.i(TAG, "createCamera: Camera focus mode: " + mFocusMode + " is not supported on this device.");

                    Log.i(TAG, "Camera focus mode: " + mFocusMode + " is not supported on this device.");
                }
            } else {
                Log.i(TAG, "createCamera: No focus mode!");
            }
            ...
            if (mFlashMode != null) {
                if (parameters.getSupportedFlashModes().contains(
                    ...
                    Log.i(TAG, "createCamera: Camera flash mode: " + mFlashMode + " is not supported on this device.");
            ...
            //:restart activity
            Log.i(TAG, "createCamera: Failed to connect to camera: " + Utils.getInstance().getStackTrace(e));
            ((MaterialBarcodeScannerActivity) cameraActivity).restartActivity();
        }
    ...
    private void setRotation(Camera camera, Camera.Parameters parameters, int cameraId) {
        ...
        switch (rotation) {
            ...
            case Surface.ROTATION_270:
                ...
                break;
            default:
                Log.i(TAG, "setRotation: Bad rotation value: " + rotation);
    ...
    private byte[] createPreviewBuffer(Size previewSize) {
        ...
        if (!buffer.hasArray() || (buffer.array() != byteArray)) {
            ...
            Log.i(TAG, "createPreviewBuffer: Failed to create valid buffer for camera source.");
    ...
    public static class Builder {
        ...
        public Builder(Context context, Detector<?> detector) {
            if (context == null) {
                Log.i(TAG, "Builder: No context supplied.");
                throw new IllegalArgumentException("No context supplied.");
            }
            if (detector == null) {
                Log.i(TAG, "Builder: No detector supplied.");
        ...
        public Builder setRequestedFps(float fps) {
            if (fps <= 0) {
                Log.i(TAG, "setRequestedFps: Invalid fps: " + fps);
        ...
        public Builder setRequestedPreviewSize(int width, int height) {
            ...
            if ((width <= 0) || (width > MAX) || (height <= 0) || (height > MAX)) {
                Log.i(TAG, "setRequestedPreviewSize: Invalid preview size: " + width + "x" + height);
        ...
        public Builder setFacing(int facing) {
            if ((facing != CAMERA_FACING_BACK) && (facing != CAMERA_FACING_FRONT)) {
                Log.i(TAG, "setFacing: Invalid camera: " + facing);
    ...
    private static class SizePair {
        ...
        public SizePair(Camera.Size previewSize,
            ...
            if (pictureSize != null) {
                ...
                Log.i(TAG, "SizePair: No picture size!");
            }
        }

        public SizePair(Size size) {
            mPreview = size;
            if (size != null) {
                mPicture = new Size(size.getWidth(), size.getHeight());
            } else {
                Log.i(TAG, "SizePair: No picture size!");
            }
        }
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            synchronized (mCameraLock) {
                if (mCamera != null) {
                    ...
                    Log.i(TAG, "onPictureTaken: Null Camera Supplied");
                }
            }
        }
    }
        ...
        void setNextFrame(byte[] data, Camera camera) {
            synchronized (mLock) {
                ...
                if (!mBytesToByteBuffer.containsKey(data)) {
                    Log.i(TAG, "setNextFrame: Skipping frame.  Could not find ByteBuffer associated with the image " +
        ...
        public void run() {
            ...
            while (true) {
                synchronized (mLock) {
                    while (mActive && (mPendingFrameData == null)) {
                        try {
                            ...
                            Log.i(TAG, "setNextFrame: Frame processing loop terminated: " + Utils.getInstance().getStackTrace(e));
                ...
                try {
                    ...
                    Log.i(TAG, "setNextFrame: Exception thrown from receiver: " + Utils.getInstance().getStackTrace(t));
